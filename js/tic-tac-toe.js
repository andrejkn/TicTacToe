var TIC_TAC_TOE_GAME = (function () {
	this.computerPlayer = '';

	var turn = 'X',
//		computerPlayer = '',
		gameEnded = false, // private
		fields = {
			field1: {
				value: '',
				adjacents: {
	...
	/** Public methods */
		 ...
		 */
		detectWinner = function (fieldClicked, cb) {
			var adjacent,
				adjFields,
				wonFields,
